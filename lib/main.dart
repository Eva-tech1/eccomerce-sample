...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Carplug KE', // Title of the application
      theme: ThemeData(
        primarySwatch: Colors.blue, // Primary color theme
        scaffoldBackgroundColor: Color.fromARGB(255, 108, 108, 104), // Background color
      ),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Map<String, String>> categories = [
      {"name":"Engine", "image": "https://images.unsplash.com/photo-1567093322102-6bdd32fba67d?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
       {"name":"Brakes","image": "https://images.unsplash.com/photo-1616788902258-138db56fe7e5?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
    {"name":"Suspension","image":"https://images.unsplash.com/photo-1669136048337-5daa3adef7b2?q=80&w=1884&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
     {"name":"Exhaust","image": "https://images.unsplash.com/photo-1619255566224-fca5ef4ca1be?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
      {"name":"Air Conditioning","image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTymCbCc8A8zn0-0JwbiZnjb3cRLPpGsTEsxA9w1dWasQ&s"},
     {"name":"Wheels","image": "https://images.unsplash.com/photo-1611633235555-45e252fe48c8?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
      ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Carplug KE'), // Title of the app bar
        actions: <Widget>[
          // Search bar
          Container(
            width: 200,
...
class CartScreen extends StatelessWidget {
  final Color cartColor = Colors.brown;
    ...
    return Scaffold(
      ...
      body:  Center(
        child : Container(
          ...
          child: Text('Shopping Cart'), // Text content of the shopping cart
